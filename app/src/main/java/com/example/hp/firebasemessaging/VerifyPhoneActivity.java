...
public class VerifyPhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView pTxt = findViewById(R.id.numberText);
        pTxt.setText(phonenumber);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            hashMap.put("id", Uid);
                            hashMap.put("usernumber", phonenumber);
                            hashMap.put("usernamer", "-");
                            */

                            UserData userData = new UserData(Uid, "-", phonenumber);
                            reference.child("Users").child(Uid).setValue(userData).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Intent intent = new Intent(VerifyPhoneActivity.this, AppActivity.class);
